...
signal IntelAdded(screenPosition, previewTexture, data)
...
func _on_DragController_IntelAdded(screenPos, previewTexture, data):
	emit_signal("IntelAdded", screenPos, previewTexture, data)
